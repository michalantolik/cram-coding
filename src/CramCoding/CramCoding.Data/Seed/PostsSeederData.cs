        ...
        internal PostsSeederData()
        {
            Posts = new Post[]
            {
                new Post // [0]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2020, 01, 25, 6, 32, 32, 425, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2020, 01, 25, 6, 32, 32, 425, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2020, 01, 25, 6, 32, 32, 425, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 23,
                },
                new Post // [1]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2020, 01, 26, 18, 32, 42, 425, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2020, 01, 26, 18, 32, 42, 425, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2020, 01, 26, 18, 32, 42, 425, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 0,
                },
                new Post // [2]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 01, 27, 21, 02, 11, 235, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 01, 27, 21, 02, 11, 235, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 01, 27, 21, 02, 11, 235, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 8,
                },
                new Post // [3]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 01, 28, 17, 45, 05, 643, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 01, 28, 17, 45, 05, 643, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 01, 28, 17, 45, 05, 643, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 64,
                },
                new Post // [4]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 01, 29, 13, 57, 32, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 01, 29, 13, 57, 32, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 01, 29, 13, 57, 32, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 21,
                },
                new Post // [5]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 01, 30, 22, 10, 42, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 01, 30, 22, 10, 42, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 01, 30, 22, 10, 42, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 53,
                },
                new Post // [6]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 01, 00, 12, 23, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 01, 00, 12, 23, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 01, 00, 12, 23, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 34,
                },
                new Post // [7]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 2, 15, 25, 06, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 2, 15, 25, 06, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 2, 15, 25, 06, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 53,
                },
                new Post // [8]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 3, 14, 22, 01, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 3, 14, 22, 01, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 3, 14, 22, 01, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 43,
                },
                new Post // [9]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 4, 13, 17, 59, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 4, 13, 17, 59, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 4, 13, 17, 59, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 74,
                },
                new Post // [10]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 5, 13, 55, 52, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 5, 13, 55, 52, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 5, 13, 55, 52, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 6,
                },
                new Post // [11]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 6, 06, 23, 45, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 6, 06, 23, 45, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 6, 06, 23, 45, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 43,
                },
                new Post // [12]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 7, 13, 12, 43, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 7, 13, 12, 43, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 7, 13, 12, 43, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 26,
                },
                new Post // [13]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 8, 10, 05, 07, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 8, 10, 05, 07, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 8, 10, 05, 07, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 57,
                },
                new Post // [14]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 9, 09, 02, 33, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 9, 09, 02, 33, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 9, 09, 02, 33, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 65,
                },
                new Post // [15]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 10, 10, 23, 44, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 10, 10, 23, 44, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 10, 10, 23, 44, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 5,
                },
                new Post // [16]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 11, 15, 53, 25, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 11, 15, 53, 25, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 11, 15, 53, 25, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 74,
                },
                new Post // [17]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 12, 16, 00, 02, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 12, 16, 00, 02, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 12, 16, 00, 02, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 36,
                },
                new Post // [18]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 13, 17, 56, 32, 04, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 13, 17, 56, 32, 04, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 13, 17, 56, 32, 04, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 54,
                },
                new Post // [19]
                {
                    ...
                    CreatedAt = new DateTimeOffset(2021, 02, 14, 13, 44, 23, 024, new TimeSpan(2, 0, 0)),
                    UpdatedAt = new DateTimeOffset(2021, 02, 14, 13, 44, 23, 024, new TimeSpan(2, 0, 0)),
                    PublishedAt = new DateTimeOffset(2021, 02, 14, 13, 44, 23, 024, new TimeSpan(2, 0, 0)),
                    IsVisible = true,
                    ViewsCount = 64,
                },
            };
